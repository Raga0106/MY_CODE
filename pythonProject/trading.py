...
def fetch_kline_price_data():
    ...
    ticker = 'BTCUSDT'
    time_interval = '1m'
    start_time = datetime(2020, 12, 1)  # 获取数据开始的时间，YYYY/M/D
    ...
    while start_time < end_time:
        ...
        url = 'https://fapi.binance.com/fapi/' + str(api_library) + '?symbol=' + str(ticker) + '&interval=' + str(
            time_interval) + '&limit=1500&startTime=' + str(start_time_2)
        print(start_time)
    ...
    # 项目命名Columns Rename
    price_data.columns = ['Time', 'Open', 'High', 'Low', 'Close', 'Volume', 'Close Time', 'Ignore', 'Ignore', 'Ignore',
                          'Ignore', 'Ignore']
